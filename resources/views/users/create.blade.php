                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="password_confirmation" class="form-label">Password (Leave blank to use default password)</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="avatar" name="avatar" accept="image/*" value="{{old('avatar')}}">
                                <div class="d-flex justify-content-center">
                                    <img id="imgPreview" src="" alt="Preview image" class="img-thumbnail d-none mt-2" style="max-width: 20rem;">
                                </div>
                                @error('avatar')
                                    <div class="alert alert-danger mt-2">{{$message}}</div>
                                @enderror
